    ...
    Edit_Receptionist(String username)
    {
        try
        {
            ...
            if(rest0.next())
            {
                ...
                id.setLayout(null);
                ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Hms/Icons/Add Receptionist.jpg"));
                Image i1=img.getImage().getScaledInstance(900,600,Image.SCALE_SMOOTH);
                ImageIcon img1=new ImageIcon(i1);
                id.setIcon(img1);
        
                id1=new JLabel("Edit Receptionist Details");
                ...
                try
                {
                    ...
                    {  
                        ...
                        t12.setText(rest.getString("Qualification"));
                        id.add(t12);
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        if(e.getSource()==b)
        {
            try
            {
                ...
                String q2="update receptionist set name='"+name+"',dob='"+dob+"',address='"+address+"',phone='"+phone+"',email='"+email+"',city='"+city+"',gender='"+gender+"',blood='"+blood+"',age='"+age+"',qualification='"+qualification+"',joining_date='"+joining+"',father_name='"+father_name+"' where username='"+username+"'";
