    ...
    Edit_Patient(String username)
    {
        try
        {
            ...
            if(rest0.next())
            {
                ...
                id.setLayout(null);
                ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("Hms/Icons/Add Patient.jpg"));
                Image i1=img.getImage().getScaledInstance(900,600,Image.SCALE_SMOOTH);
                ImageIcon img1=new ImageIcon(i1);
                id.setIcon(img1);
        
                id1=new JLabel("Edit Patient Details");
                ...
                try
                {
                    ...
                    {  
                        ...
                        t12.setText(rest.getString("material_status"));
                        id.add(t12);

                        t13=new JTextField();
                        t13.setBounds(200,400,150,30);
                        t13.setText(rest.getString("deceased"));
                        id.add(t13);

                        t14=new JTextField();
                        t14.setBounds(200,450,150,30);
                        t14.setText(rest.getString("father_name"));
                        id.add(t14);
                    }
                }
                catch(Exception exx)
            ...
            {
                JOptionPane.showMessageDialog(null,"Record not found, Please fill the right Patient Username !");
...
//                new View_Patient().setVisible(true);
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        String material_status = t12.getText();
        String deceased = t13.getText();
        String father_name = t14.getText();
        ...
        if(e.getSource()==b)
        {
            try
            {
                ...
                String q2="update patient set name='"+name+"',dob='"+dob+"',address='"+address+"',phone='"+phone+"',email='"+email+"',city='"+city+"',gender='"+gender+"',blood='"+blood+"',age='"+age+"',material_status='"+material_status+"',deceased='"+deceased+"',father_name='"+father_name+"' where username='"+username+"'";
