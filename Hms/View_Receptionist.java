...
{
    String x[]={"Name","Username","Email","Father Name","Phone","Qualification","City","gender","Blood Group","Age","DOB","Joining Date","Address"};
    JButton bt,bt1;
    ...
    View_Receptionist(int login_id)
    {
        ...
        if(login_id==1)
        {
            ...
            l1=new JLabel("Delete or Edit any Receptionist ?");
            l1.setHorizontalAlignment(JLabel.CENTER);
            l1.setFont(f1);
            l1.setForeground(Color.YELLOW);

            l2=new JLabel("Receptionist Username");
            l2.setFont(f1);
