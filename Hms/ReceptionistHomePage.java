...
public class ReceptionistHomePage extends JFrame implements ActionListener
{
    ...
    ReceptionistHomePage(String receptionistname, String receptionistid, int login_id)
    {
        ...
        ImageIcon ic=new ImageIcon(ClassLoader.getSystemResource("Hms/Icons/Receptionist.jpg"));
...
//        JMenuItem ment5=new JMenuItem("Add Receptionist");
        ...
        JMenu men5=new JMenu("Hello, Receptionist ("+receptionistname+")");
...
//        ment5.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) 
    {
        ...
        {
            new View_Patient("xyz",login__id).setVisible(true);
        }
        ...
        {
            new AddAppointment("xyz",login__id).setVisible(true);
        }
        else if(comnd.equals("View Appointment"))
        {
            new View_Appointement("xyz",login__id).setVisible(true);
        }
